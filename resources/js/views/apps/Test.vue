<template>
    <div>
        ...
        <ul>
            <ListItem v-for="people in peoples" :key="people.id" :id="people.id" :people="people.name"
                :is-active="people.id === activeId" />
        </ul>
...
import Input from '@/views/apps/components/Input.vue';
import MultipleInput from '@/views/apps/components/MultipleInput.vue';
import ListItem from '@/views/apps/components/ListItem.vue';
import data from '@/views/api/Users.js';
import Apis from '@/views/api/Apis.js';
